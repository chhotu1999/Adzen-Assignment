...
public class InventoryAssignmentDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InventoryAssignmentDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
