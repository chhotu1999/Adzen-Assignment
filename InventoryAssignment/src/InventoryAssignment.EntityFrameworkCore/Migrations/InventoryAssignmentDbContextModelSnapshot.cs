...
{
    [DbContext(typeof(InventoryAssignmentDbContext))]
    partial class InventoryAssignmentDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryAssignment.Customer.CustomerModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryAssignment.Product.ProductModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryAssignment.Sales.MvSales", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InvSales", (string)null);
                });

            modelBuilder.Entity("InventoryAssignment.Sales.MvSalesDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MvSalesId");

                    b.HasIndex("ProductId");

                    b.HasIndex("SalesId");

                    b.ToTable("InvSalesDetail", (string)null);
                });

            modelBuilder.Entity("InventoryAssignment.StockSummary.StockSummaryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryAssignment.Sales.MvSales", b =>
                {
                    b.HasOne("InventoryAssignment.Customer.CustomerModel", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryAssignment.Sales.MvSalesDetail", b =>
                {
                    b.HasOne("InventoryAssignment.Sales.MvSales", null)
                        .WithMany("SalesDetails")
                        .HasForeignKey("MvSalesId");

                    b.HasOne("InventoryAssignment.Product.ProductModel", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryAssignment.Sales.MvSales", "Sales")
                        .WithMany()
